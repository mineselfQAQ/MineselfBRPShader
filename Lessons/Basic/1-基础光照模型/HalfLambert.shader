//HalfLambert是Lambert的一种变体
Shader "MineselfShader/Basic/1-BasicLightingModel/HalfLambert"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                //光照计算
                //这里只有漫反射项，使用的是HalfLambert
                //核心就是lDir·nDir
                //有别于Lambert，不是使用saturate()限制，而是使用*0.5+0.5进行映射，将其从[-1,1]映射到[0,1]
                float diffuse = dot(lDir, nDir) * 0.5 + 0.5;
