Shader "MineselfShader/Basic/13-NormalBlend&NormalAtlas/NormalBlend/PD"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float3 blendNormal = float3(n1.xy * n2.z + n2.xy * n1.z, n1.z * n2.z);//使用偏导方法计算
                //等价于
                //float3 blendNormal = float3(n1.xy / n1.z + n2.xy / n2.z, 1);
